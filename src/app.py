...
# from src.api.models import db, User, EstadoComanda, EstadoMesa , Plates, Tables, Orders, Orders_Plates
...
@app.routes('/tables/<int:table_id>', methods=['PUT'])
